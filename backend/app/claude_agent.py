...
Шаг 4. Только если A>2 или C>2 — компания не помещается в один домик,
  ...
  где применимо).
Шаг 5. Доплата 1000 ₽/сутки берётся за каждого ребёнка СТАРШЕ 10 лет
  В ЭТОМ домике — независимо от вместимости, это отдельный от вместимости
  вопрос оплаты.
...
Расчёт: 7000 ₽/сутки × 2 ночи = 14000 ₽ (домик)
      + 1000 ₽ × 2 ребёнка старше 10 лет × 2 ночи = 4000 ₽ (доплата)
      = 18000 ₽ итого. Домик один, не два.
